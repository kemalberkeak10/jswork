        ...
        $.get(url, function(r) {
            if (r.Status && r.ekstreListe.length > 0) {
                ...
                $.each(r.ekstreListe, function(i, v) {
                    alacakInt += parseFloat(v.Alacak);
                    borcInt += parseFloat(v.Borc);
                    ...
                    if (alacakInt > borcInt) {
                        newRow.append($('<td style="text-align: left;" class="col-md-2" />').text(v.Bakiye + '(A)'));
                    } else if (borcInt > alacakInt) {
                        newRow.append($('<td style="text-align: left;" class="col-md-2" />').text(v.Bakiye + '(B)'));
                    } else {
