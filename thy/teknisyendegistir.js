$(function() {
    ...
    if (!String.isNullOrWhiteSpace(oldTechnicianId)) {
        $('label[for=229E6919177C49229ADC807F42F67E94]').parents('div:eq(0)').append('<a id="btnChangeTechnician" class="btn btn-xs btn-warning" ">Change Technician<i class="fas fa-arrow-circle-right" style="margin-left:5px;"></i></a>')
    }
