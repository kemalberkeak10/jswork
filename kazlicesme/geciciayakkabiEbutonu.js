...
$(function() {
    $('.table-responsive').find('th:eq(0)').css("text-align", "center");
    $('.table-responsive').find('th:eq(0)').append('<input id=selectAll class="form-check" style="text-align:center" type="checkbox">')
