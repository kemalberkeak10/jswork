        ...
        function() {
            ...
            if (!urunGrubuDieago && $('#sonucNotu').val() === "") {
                ...
                if (!urunGrubuDieago && $('#sikayetliUrun').val() === "") {
                    ...
                    var url = 'https://meyicki.setcrm.com/api/data/RaporGuncelle';
                    var url2 = 'http://localhost:50058/api/data/RaporGuncelle';
                    ...
                    $.post(url, data, function(r) {
                        if (r.Status) {
                            ...
                            if (r.formType === 0) {
                                window.open(' https://proje.setcrm.com/formtemplate/get/?id=D1E77B206774406899F00F9EFFCDDD84&coId=85DA4222C20E45329815EE7D0AA14C1E&recordId=' + $('#RecordPublicId').val(), "_blank");
                            } else if (r.formType === 1) {
                                window.open('https://proje.setcrm.com/formtemplate/get/?id=F5E8E977072743F4B063ECF2C92646D4&coId=85DA4222C20E45329815EE7D0AA14C1E&recordId=' + $('#RecordPublicId').val(), "_blank");
                            } else if (r.formType === 2) {
                                window.open('https://proje.setcrm.com/formtemplate/get/?id=F5E8E977072743F4B063ECF2C92646D4&coId=85DA4222C20E45329815EE7D0AA14C1E&recordId=' + $('#RecordPublicId').val(), "_blank");
                            } else if (r.formType === 3) {
                                window.open(' https://proje.setcrm.com/formtemplate/get/?id=AFE0D2BAED724E5092E988B3024F1490&coId=85DA4222C20E45329815EE7D0AA14C1E&recordId=' + $('#RecordPublicId').val(), "_blank");
                            }
                            // }
                            setTimeout(() => {
