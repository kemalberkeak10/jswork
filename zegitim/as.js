$(function() {
    ...
    function setAGUrunGrubu() {
        $.get("https://maya.setcrm.com/Summary/LookupFieldValues", {
                ...
                controllingRecordId: $('label[for=5AFA62276DE74CEDACF22C1F49BABC48]').closest('div').data('selecteditempublicids'),
    ...
    function setAGProssesBasamagi() {
        $.get("https://maya.setcrm.com/Summary/LookupFieldValues", {
                ...
                controllingRecordId: $('label[for=D349E1519DD5463D8200FD72C6088F42]').closest('div').data('selecteditempublicids'),
                coId: '283FD563B0BC4BF0BE50BE1126538CEE',
                itemId: "5610B85C662F486FB6C378712F8C0536",
                groupIds: "552BC6515BF44269B6FC5088AAF09936",
