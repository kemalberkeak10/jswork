$(function() {
    ...
    $("body").on('click', '#btnLabSonucGirisi', function() {
        if (String.isNullOrWhiteSpace(cihazAlani)) {
            ...
            }).append($("<thead/>").html('<tr><th style="text-align:; vertical-align:middle;width:5%;" class="col-md-1"><input id="selectAll" type="checkbox"></th><th style="text-align: center; vertical-align:middle;width:5%;">Referans No</th><th style="text-align: center; vertical-align:middle;width:14%;">Referans İsmi</th><th style="text-align: center; vertical-align:middle;">Sonuç</th><th style="text-align: center; vertical-align:middle;">D.Limiti</th><th style="text-align: center; vertical-align:middle;">RMRL</th><th style="text-align: center; vertical-align:middle;">Ölçüm Belirsizliği Miktarı</th><th style="text-align: center; vertical-align:middle;width:8%">Ölçüm Belirsizliği Birimi</th><th style="text-align: center; vertical-align:middle;">Raporlama Limiti</th><th style="text-align: center; vertical-align:middle;">Ö.B.</th><th style="text-align: center; vertical-align:middle;">G.K.</th><th style="width:10%;">Enstürmantel Analiz Cihazı</th><th style="text-align: center; vertical-align:middle;width:8%;">Analiz Metodu</th><th style="text-align: center; vertical-align:middle;width:8%;">D. Mevzuatı</th></tr>')).append($('<tbody/>')));
            selectedRecords.append($('<table/>', {
                class: 'table table-bordered table-hover',
                'style': 'margin-bottom:0;table-layout: fixed;'
            }).append($("<thead/>").html('<tr><th style="text-align:; vertical-align:middle;width:5%;" class="col-md-1"></th><th style="text-align: center; vertical-align:middle;width:5%;">Referans No</th><th style="text-align: center; vertical-align:middle;width:14%;">Referans İsmi</th><th style="text-align: center; vertical-align:middle;">Sonuç</th><th style="text-align: center; vertical-align:middle;">D.Limiti</th><th style="text-align: center; vertical-align:middle;">RMRL</th><th style="text-align: center; vertical-align:middle;">Ölçüm Belirsizliği Miktarı</th><th style="text-align: center; vertical-align:middle;width:8%">Ölçüm Belirsizliği Birimi</th><th style="text-align: center; vertical-align:middle;">Raporlama Limiti</th><th style="text-align: center; vertical-align:middle;">Ö.B.</th><th style="text-align: center; vertical-align:middle;">G.K.</th><th style="width:10%;">Enstürmantel Analiz Cihazı</th><th style="text-align: center; vertical-align:middle;width:8%;">Analiz Metodu</th><th style="text-align: center; vertical-align:middle;width:8%;">D. Mevzuatı</th></tr>')).append($('<tbody/>')));
    ...
    function getReferenceList(page) {
        ...
        var url = 'https://betalabwebapi.setcrm.com/api/data/LabSonucuVfOkumaWithQ?q=' + $('#searchReferans').val() + "&page=" + page;
        var localurl = 'https://localhost:44303/api/data/LabSonucuVfOkumaWithQ?q=' + $('#searchReferans').val() + "&page=" + page;
