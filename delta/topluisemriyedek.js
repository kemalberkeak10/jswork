$(function() {
        ...
        window.setModal.Create({
            ...
            html: {
                ...
                body: '<div id="modalTopluIsEmriMessage"></div>' +
                    ...
                    '<th style="background:#ff9500; text-align:center;">Kalan Adet</th>' +
                    ...
                    '<td colspan="1" rowspan="1"><input id="Bolum" type="text" style="width:100%; border-radius: 3px; border: 1px solid #ffc694; padding: 8px 12px;"></td>' +
                    ...
                    '<td colspan="1" rowspan="1"><input id="BaslangicZamani" type="text" style="width:100%; border-radius: 3px; border: 1px solid #ffc694; padding: 8px 12px;"></td>' +
                    '<td colspan="1" rowspan="1"><input id="BitisZamani" type="text" style="width:100%; border-radius: 3px; border: 1px solid #ffc694; padding: 8px 12px;"></td>' +
                    ...
                    '<td colspan="1" rowspan="1"><input id="Kalan" type="text" style="width:100%; border-radius: 3px; border: 1px solid #ffc694; padding: 8px 12px;" disabled></td>' +
    ...
    // $('body').on('change', '#IsEmri', function() {
    //     urunId = $('#IsEmri').val();

    //     var localUrl = String.format('http://localhost:62144/api/data/TopluIsEmriOperasyon?recordId=' + urunId);
    //     var realUrl = String.format('https://deltawebapi.setcrm.com/api/data/TopluIsEmriOperasyon?recordId=' + urunId);

    //     $.get(localUrl, function(r) {
    //         if (r.Status) {
    //             OperasyonList = r.operasyonList;
    //             prepareSelect2WithData('#Operasyon', r.operasyonList);
    //         } else {
    //             setUtil.alert({
    ...
    $('body').off('change',
        '#BaslangicZamani,#BitisZamani,#Operasyon,#Tarih').on('change',
        '#BaslangicZamani,#BitisZamani,#Operasyon,#Tarih',
        function() {
    ...
    function AddToTable() {
        var UrunId, UrunText, isEmriNo, operasyonId, operasyonText, makineId, makineText, personelId, personelText, uretilecekAdet, uretilenAdet, fire,
            bosaAkma, kalanUretimAdeti, durumId, durumText, baslamaZamani, bitisZamani, durusSuresi, durusNedeni, calismaZamani;
        isEmriNo = $('#IsEmri').val();
        ...
        newRow.append('<td style="width:80px;"><input id="' + String.format('kalanUretimAdetiNew_{0}', newRowIndex) + '" type="text"  style="width:100px; height:40px; border-radius: 3px; border: 1px solid #ffc694; padding: 8px 12px;" class="form-control kalan-uretim-adeti" disabled value=' + kalanUretimAdeti + '></td>');
    ...
    function AddToTableWithIndex(tr, index) {
        ...
        kalanUretimAdeti = tr.find('#kalanuretimAdetiNew_' + index).val();
        durumId = "34172E76AC98455C94FB934B8AECB4F6";
        durumText = "Üretiliyor";
        ...
        $('#KalanUretimAdeti').val(kalanUretimAdeti);
    ...
    function UpdateOrders() {
        ...
        $.each(trListNew,
            function(i, v) {
                ...
                var kalanuretimAdeti = $('#kalanUretimAdetiNew_' + rowId).val();
                ...
                var model = {
                    ...
                    Tarih: tarihIsEmri,
                    BosaAkma: bosaAkma,
                    KalanUretimAdeti: kalanuretimAdeti,
