$(function() {
    ...
    $('body').on('click', '#btnFormOlustur', function() {
        ...
        if (listUrunler.includes('Alaçatı')) {
            dosyaTipi = "alacati";
            $('#modalSablon .gradient-list').append('<div><a class="alacatiBtn form-control" style="border: 2px solid #18BC9C;cursor:pointer;">Alaçatı</a></div>');
        } else {
            dosyaTipi = "torba";
    ...
    $("body").on("click",
        ...
        function() {
            ...
            $('.modal-footer').hide();
            var recordId = $('#RecordPublicId').val();
            var localUrl = "https://localhost:44305/api/data/AlacatiSablon?recordId=" + recordId + "&dosyaTipi=" + dosyaTipi + "&odemeSekli=" + odemeSekli;
            var realurl = "https://nefwebapi.setcrm.com/api/data/AlacatiSablon?recordId=" + recordId + "&dosyaTipi=" + dosyaTipi + "&odemeSekli=" + odemeSekli;
