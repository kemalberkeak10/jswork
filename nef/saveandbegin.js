$(function() {
    ...
    function musteriKontrol(e) {
            ...
            window.setModal.Create({
                ...
                html: {
                    ...
                    body: '<div id="adresMsg"></div>' +
                        ...
                        '<table class="table" style="width: 100%">' +
                        '<thead>' +
                        '<tr><th style="background:#21d961; tex-align:left">Mahalle/Sokak Açık Adres/Cadde</th></tr>' +
                        '</thead>' +
                        '<tbody>' +
                        '<tr>' +
                        '<td><input class="form-control" id="acikAdres" type="text" style="resize: vertical; width:100%;"></input></td>' +
                        '</tr>' +
                        '</tbody>' +
                        '</table>' +
                        '<table class="table" style="width: 100%">' +
        ...
        function checkValidationAdres() {
            ...
            if (yurtDisi || diger) {
                return true;
            } else if (String.isNullOrWhiteSpace($('#acikAdres').val()) || String.isNullOrWhiteSpace($('#postaKodu').val()) || String.isNullOrWhiteSpace($('#il').select2('data')) || String.isNullOrWhiteSpace($('#ilce').select2('data'))) {
                $('#musteriMsg').show();
                setUtil.alert({
