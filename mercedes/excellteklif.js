$(function() {
    ...
    if (filtreId == '24F1A590081441A5AF1125A812E3AA1D') {
    ...
    $('body').on('click', '#btnTeklifAlExcel', function() {
        ...
        if (!isExistTeklif) {
            ...
            var headerViewData2 = [
                { id: 'EA8B2DF8483D4051A27BDD27CFCB8473', text: 'Türkçe' },
                { id: 'E482ABCB4EB845CDAD5283F63629B28E', text: 'İngilizce' },
            ];
    ...
    $('body').on('click', '#btnKaydetTTopluTeklif',
        function() {
            $('.modal-footer').hide();
