                    ...
                    if (result.PagedItems.ItemCount > 0) {
                        ...
                        for (var i = 0; i < tarih.length; i++) {
                            for (var j = 0; j < cityName.length; j++) {
                                ...
                                newRow.append($('<th style="text-align: center;white-space: pre;color:yellow; background-color:black;position: sticky;top: 0;z-index: 5;" class="col-md-2">' + tarih[i] + ' ' + cityName[j] + '<i class="fa fa-chevron-circle-right r' + i + ' ' + i + '" style="margin-left:5px;"></i><i class="fa fa-chevron-circle-left l' + i + ' ' + i + '" style="display:none;margin-left:5px;"></i></th>'));
                                newRow.append($('<th style="display:none;text-align: center;white-space: pre;color:yellow; background-color:black;position: sticky;top: 0;z-index: 5;" class="col-md-2 finished-th' + i + '"/>').text("Çalışılmış Saat"));
                                newRow.append($('<th style="display:none;text-align: center;white-space: pre;color:yellow; background-color:black;position: sticky;top: 0;z-index: 5;" class="col-md-2 remaining-th' + i + '"/>').text("Kalan Saat"));
                            ...
                            for (var i = 0; i < tarih.length; i++) {
                                ...
                                for (var j = 0; j < cityName.length; j++) {
                                    newRow.append($('<td style="display:none;text-align: center;padding-left: 0px;padding-right: 0px;"/>').append($('<input />', {
                                        ...
                                        'value': '',
                                        'class': 'col-md-2',
                                        'class': 'finished-hour' + tarih[i] + " finished",
                                        'text-align': 'center',
                                        'min': '0',
                                        'data-id': tarih[i],
                                        'data-city': cityName[j],
                                ...
                                for (var j = 0; j < cityName.length; j++) {
                                    newRow.append($('<td style="display:none;text-align: center;padding-left: 0px;padding-right: 0px;"/>').append($('<input />', {
                                        ...
                                        'value': '',
                                        'class': 'col-md-2',
                                        'class': "remaining-hour" + tarih[i] + " remaining",
                                        'text-align': 'center',
                                        'min': '0',
                                        'data-id': tarih[i],
                                        'data-city': cityName[j],
                        ...
                        for (var i = 0; i < tarih.length; i++) {
                            ...
                            for (var j = 0; j < cityName.length; j++) {
                                newRow2.append($('<td style="display:none;text-align: left;padding-left: 0px;padding-right: 0px;" class="col-md-2"/>').append($('<input />', {
                                    ...
                                    'height': '50px',
                                    'value': '',
                                    'class': 'col-md-2 ' + cityName[j] + '-' + tarih[i],
                                    disabled: true
                                })));
                            }
                            for (var j = 0; j < cityName.length; j++) {
                        ...
                        //     $('.remaining-th' + i).show();
                        //     debugger;
                        //     var remainingRows = $('#modalRemainingHour #kp #newTbl tbody tr').find("td:eq(" + "'" + i + "'" + ") .remaining");

                        //     remainingRows.each(function(i, v) {

                        //         $(this).show();
                        //     });
                        //     remainingRows = $('#modalRemainingHour #kp #newTbl tbody tr').find("td:eq(" + "'" + (i - 1) + "'" + ") .remaining");
                        //     $.each(remainingRows, function(i, v) {
                        //         console.log(v);
                        //         $(this).show();
                        //         debugger;
                        //         // el.find('#remaining' + i).parent()[0].display = "";
                        //         // el.find('#finished' + i).parent()[0].display = "";
                        //         // el.find('#remaining_' + i).parent()[0].display = "";
                        //         // el.find('#finished_' + i).parent()[0].display = "";
                        //     });
                        // });
                        ...
                        $("body").on("click", ".fa-chevron-circle-right", function() {
                            ...
                            $('.finished-th' + i).show();
                            $('.remaining-th' + i).show();
                            var tumRemainings = $('.remaining');
                            var tumFinished = $('.finished');
                            tumRemainings.each(function(index, v) {
                                var id = $(this)[0].id;
                                if (id == 'remaining' + i) {
                                    console.log(v);
                                    $(v).closest('td').show();
                            ...
                            tumFinished.each(function(index, v) {
                                var id = $(this)[0].id;
                                if (id == 'finished' + i) {
                                    console.log(v);
                                    $(v).closest('td').show();
                            ...
                            $('#remaining_' + i).closest('td').show();
                            $('#finished_' + i).closest('td').show();
                        });
                        ...
                        $("body").on("click", ".fa-chevron-circle-left", function() {
                            ...
                            $('#remaining_' + i).closest('td').hide();
                            $('#finished_' + i).closest('td').hide();
                        });
                        newRow2.append($('<td style="text-align: left;padding-left: 0px;padding-right: 0px;"/>').append($('<input />', {
                            'id': 'worhBottomTotal',
                        ...
                        $('#modalRemainingHour #kp #newTbl tbody tr td').on('blur', '.ınpuT', function(event) {
                            ...
                            // if (!(worthCheckUpdate)) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (!(worthAksarayCheck)) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (!(aksarayCheckUpdate)) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (avw60Total > parseInt($('#team1').val())) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (avw152Total > parseInt($('#team2').val())) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (parseInt(brazilTotalHour) > parseInt($('#team3').val()) || parseInt(aksarayTotalHour) > parseInt($('#team2').val()) || parseInt(worthTotalHour) > parseInt($('#team1').val())) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (parseInt($('#satirTotal').val().split(':')[1].trim()) > parseInt($('#projectTotalHours').val().split(':')[1].trim())) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if ((redVarmiAksayar)) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if ((redVarmiWorth)) {
                            //     $('#btnUpdateUP').prop('disabled', true);
                            // } else if (parseInt($('#satirTotal').val().split(':')[1].trim()) <= parseInt($('#projectTotalHours').val().split(':')[1].trim())) {
                            //     $('#btnUpdateUP').prop('disabled', false);
                            // }
                        });



                        //TODO BURaları Kontrol edilcektin
                        ...
                        $('body').on('click', '#btnUpdateUP', function() {
                            $('#modalLoadingUpdate').remove();
                            window.setModal.Create({
                                id: 'modalLoadingUpdate',
                                html: {
                                    header: ' ',
                                    body: '<div id="txt" style="margin:0 0 5px; width: 100%;">Update in progress, please wait..<br/> <img src="/Public/img/loading_bar.gif"></div>',
                                    footer: '<button class="btn btn-sm btn-default" data-dismiss="modal" >Close</button>'
                                }
                            });
                            $('#modalRemainingHour').modal('toggle');
                            ...
                            if (datas.length > 0) {
                                datas.each(function(i, v) {
                                    for (var i = 0; i < satirCount; i++) {
                                        var hour = parseInt($(this).find('#hour' + i).val()) || 0;
                                        if (hour != 0 && !isNaN(hour)) {
                                            var veri = $(this).find('#groupName').data('id').split('-');
                                            var parametreler = {
                                                TeamId: veri[1],
                                                TeamName: veri[0],
                                                GroupId: veri[2],
                                                GroupName: $(this).find('#groupName').val(),
                                                City: $(this).find('#hour' + i).data('id').split('-')[0],
                                                Year: "01.01." + $(this).find('#hour' + i).data('id').split('-')[1],
                                                Hour: hour,
                                                Check: false,
                                                RecordId: $(this).find('#hour' + i).attr('name')
                                            };
                                            parametreList.push(parametreler);
                                        }
                                        if (hour == 0 && $(this).find('#hour' + i).attr('name') !== "" && $(this).find('#hour' + i).attr('name') !== undefined) {
                                            var veri = $(this).find('#groupName').data('id').split('-');
                                            var parametreler = {
                                                TeamId: veri[1],
                                                TeamName: veri[0],
                                ...
                                var datas3 = $('#modalRemainingHour #kp #newTbl tbody tr');
                                datas3.each(function(n, v) {
                                    if (n <= 13) {
                                        var aksaray152 = parseInt($(this).find('#aksarayAwm' + n).val()) || 0;
                                        if (aksaray152 != 0 && !isNaN(aksaray152)) {
                                            var veri = $(this).find('#groupName').data('id').split('-');
                                            var parametreler = {
                                                TeamId: veri[1],
                                                TeamName: veri[0],
                                                ...
                                                GroupName: $(this).find('#groupName').val(),
                                                City: "Aksaray",
                                                Year: "01.01." + moment(new Date()).format('YYYY'),
                                                Check: true,
                                                Hour: aksaray152,
                                                RecordId: $(this).find('#aksarayAwm' + n).attr('name')
                                            };
                                            parametreList.push(parametreler);
                                        }
                                        if (aksaray152 == 0 && $(this).find('#aksarayAwm' + n).attr('name') !== "" && $(this).find('#aksarayAwm' + n).attr('name') !== undefined) {
                                            var veri = $(this).find('#groupName').data('id').split('-');
                                            var parametreler = {
                                                TeamId: veri[1],
                                                TeamName: veri[0],
                                        ...
                                        var worth060 = parseInt($(this).find('#worthAwm' + n).val()) || 0;
                                        if (worth060 != 0 && !isNaN(worth060)) {
                                            var veri = $(this).find('#groupName').data('id').split('-');
                                            var parametreler = {
                                                TeamId: veri[1],
                                                TeamName: veri[0],
                                                ...
                                                Check: true,
                                                Hour: worth060,
                                                RecordId: $(this).find('#worthAwm' + n).attr('name')
                                            };
                                            parametreList.push(parametreler);
                                        }
                                        if (worth060 == 0 && $(this).find('#worthAwm' + n).attr('name') !== "" && $(this).find('#worthAwm' + n).attr('name') !== undefined) {
                                            var veri = $(this).find('#groupName').data('id').split('-');
                                            var parametreler = {
                                                TeamId: veri[1],
                                                TeamName: veri[0],
                                ...
                                data = {
                                    ProjectStartDate: $('#startDate').val(),
                                    ProjectFinishDate: $('#endDate').val(),
                                    ProjectTotalHour: $('#teamHours').val(),
                                    ProjectRecordId: $('#RecordPublicId').val()
                                }
                                var ProjectInformation = JSON.stringify(parametreList);
                                data.ProjeUpdateJsonData = ProjectInformation;
                                var url = "https://aksaraywebapi.setcrm.com/api/data/UpdateProjectHours";
                                var url2 = "http://localhost:54006/api/data/UpdateProjectHours";
                                var url4 = "https://webapibbs-inklab-test.tr152.corpintra.net/api/data/UpdateProjectHours";
                                var url3 = "https://webapibbs-inklab.tr152.corpintra.net/api/data/UpdateProjectHours";
                                $.post(url3,
                                    data,
                                    function(result) {
                        ...
                        if (memberResult.PagedItems.ItemCount > 0) {
                                ...
                                function(key, value) {
                                    ...
                                    if (memberDatas.length > 0) {
                                        memberDatas.each(function(i, v) {
                                            // Sub group satırı
                                            if (subTeamId === $(this).find('#groupName').data('id').split('-')[2]) {
                                                // $(this).find('.finished-hour').data('id') == value.Year
                                                var finishedInput = $(this).find('.finished-hour' + value.Year);
                            ...
                            if (memberRows.length > 0) {
                                memberRows.each(function(i, v) {
                                    ...
                                    inputs.each(function(i, input) {
                                        var totalHourRow = $(this).closest('tr').find('#hour' + i).val();
                                        var finishedHourRow = $(this).closest('tr').find('#finished' + i).val();
                                        if (!String.isNullOrWhiteSpace(totalHourRow)) {
                                            if (String.isNullOrWhiteSpace(finishedHourRow)) {
                                                finishedHourRow = 0;
                                                $(this).closest('tr').find('#finished' + i).val(finishedHourRow);
                                            }
                                            $(this).closest('tr').find('#remaining' + i).val(parseInt(totalHourRow) - parseInt(finishedHourRow));
                                        }
                                    });
                            ...
                            $('#modalRemainingHour #kp #newTbl thead th').each(function(index) {
                                ...
                                if ($(this).text() === 'Çalışılmış Saat') {
                                    ...
                                    $('#finished_' + lastTdCount).val(totalFinishedHour);
                                    lastTdCount++;
                                }
                            })
                            var lastRemainingTdCount = 0;
                            $('#modalRemainingHour #kp #newTbl thead th').each(function(index) {
                                totalRemainingHour = 0;
                                if ($(this).text() === 'Kalan Saat') {
                                    ...
                                    $('#remaining_' + lastRemainingTdCount).val(totalRemainingHour);
                                    lastRemainingTdCount++;
                                }
                            })
                        } else {
                            alertMsg('You cannot update until the distributed project hours are less or equals.');
