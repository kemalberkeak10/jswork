$(function() {
    ...
    if (topluFiltreId == '873FDD4124E343EDBE8EF0221CCDC7E1' || topluFiltreId == "5D7E7F6B58BB4B379C654FFBDAEC54AB" || topluFiltreId == "84620E952CBE4698BB295FDB61C001F9") {
        $('.well .pull-right:eq(0)').prepend('<a id="btnTopluExcel" class="btn btn-sm btn-success pull-left"  style="margin-right:10px;"><i class="fas fa-fw fa-2xl fa-file-excel"></i>Tümüyle Excel Al</a>');
        ...
        $('body').on('click', '#btnTopluExcel', function() {
            ...
            var url = 'https://webapi-inklab.tr152.corpintra.net/api/data/TumuyleTeklifAlExcelIndir';
