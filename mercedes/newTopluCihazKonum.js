$(function() {
    ...
    $('body').on('click',
        ...
        function() {
            ...
            var topluCihazKonumuTxt = $('#topluCihaz').select2('data').text;
            var data = {
                CustomObjectPublicId: $('#CustomObjectPublicId').val(),
                CihazKonumId: topluCihazKonumuVal,
                CihazKonumText: topluCihazKonumuTxt,
                Fields: recordList,
            }
            $('#selectTopluCihaz').hide();
            $('#msg').show();
            var url = 'https://webapi-inklab-test.tr152.corpintra.net/api/data/TopluCihazKonumUpdate';
