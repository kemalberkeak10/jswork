$(function() {
    ...
    $('body').on('click', '#btnEimzaTest', function() {
        ...
        var url = 'https://neteswebapilocal.setcrm.com/api/data/TopluSertifikaImzala1Yeni?imzalar=' + recordId + '&userId=' + userId;
        var testurl = 'http://localhost:58305/api/data/TopluSertifikaImzala1Yeni?imzalar=' + recordId + '&userId=' + userId;
        if (imzsertifika !== "") {
            url = 'https://neteswebapilocal.setcrm.com/api/data/TopluSertifikaImzala2Yeni?imzalar=' + recordId + '&userId=' + userId;
            testurl = 'http://localhost:58305/api/data/TopluSertifikaImzala2Yeni?imzalar=' + recordId + '&userId=' + userId;
        }
        $('#modalEimzaTest').modal('toggle');
        window.open(url);
    });
