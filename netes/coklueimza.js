$(function() {
    ...
    $('body').on('click', '#eimzaOlustur', function() {
        ...
        //var url = 'http://localhost:58305/api/data/TopluSertifikaImzala1YeniEtugra?imzalar=' + imzalar;
        $('#modalEimza').modal('toggle');
        window.open(url);
    });
    ...
    $('body').on('click', '#eimzaOlustur2', function() {
        ...
        // var url = 'https://neteswebapilocal.setcrm.com/api/data/TopluSertifikaImzala2YeniEtugra?imzalar=' + imzalar;
        var url = 'https://neteswebapilocal.setcrm.com/api/data/TopluSertifikaImzala2YeniEtugra?imzalar=' + imzalar;
        $('#modalEimza').modal('toggle');
        window.open(url);
    });
