$(".pull-right").prepend(
  '<a id="btnIskontoHesapla" class="btn btn-sm btn-warning"  style="margin-right:10px;" >Hesaplama</a>'
);
$("body").on("click", "#btnIskontoHesapla", function () {
  ...
  var url =
    "https://maya.setcrm.com/api/data/IskontoHesaplama?recordId=" + RecordId;
  var url2 =
    "http://localhost:64038/api/data/IskontoHesaplama?recordId=" + RecordId;
