$(function() {
    if ($('#LayoutPublicId').val() === '9374D4370BAF48F58536C854F817C23F') {
        ...
        $('.well .pull-right').prepend('<a id="btnSonucFormuEimzaYeni" class="btn btn-sm btn-primary" > Analiz Sonuç Bildirim Formu Eimza Gönder Yeni</a>');
        $('body').on('click', '#btnSonucFormuEimzaYeni', function() {
