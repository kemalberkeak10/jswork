$(function () {
    $('.btn-br-actions[data-publicid=CE5F0D4852864FF38A7798DD4EEC89D9]').hide();
    $('.btn-br-actions[data-publicid=CE5F0D4852864FF38A7798DD4EEC89D9]').closest('td').prepend('<a id="btnFabrikaGonder" class="btn btn-sm btn-warning"  style="margin-right:10px;" >Satış Onay</a>');
    
    $('body').on('click', '#btnFabrikaGonder', function () {
    $('#modalSablon').remove();
    window.setModal.Create({
    id: 'modalSablon',
    html: {
    content: 'style="width:900px !important"',
    header: 'Fabrika Geri Gönder',
 ...
 '<th>Açıklama</th>' +
    ...
    id: musteriTalebiId, text: musteriTalebiVal
    }).trigger('change');
