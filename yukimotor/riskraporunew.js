            ...
            function(r) {
                if (r.Status && r.count != 0) {
                    ...
                    $.each(r.detailModel, function(i, v) {
                        ...
                        newRow.append($('<td style="text-align: right;" class="col-md-1" />').text(" "));
                    ...
                    // newRowSum.append($('<td style="text-align: right;background-color:#D3D3D3;" class="col-md-1 "/>').text(limit.toFixed(2)));
