$(function() {
    ...
    var devredildi = $('label[for=BC9926716A98435792F37B92D11E13F5]').parent().data().value;

    if (!String.isNullOrWhiteSpace($('label[for=DD3EDB92E3914A58BCD9C88C908C694D]').parent().data())) {
        if ($('label[for=DD3EDB92E3914A58BCD9C88C908C694D]').parent().data().publicids == 'D03A00D11BBB428CA75A44C75F9F9C85' || $('label[for=DD3EDB92E3914A58BCD9C88C908C694D]').parent().data().publicids == '614EF74F2B8B4A509F6025B7719D4F59' || $('label[for=DD3EDB92E3914A58BCD9C88C908C694D]').parent().data().publicids == 'BBC3D7A4623B4150A7BFBBDAA8702049') {
            $('#btnServisDevret').hide();
        } else {
            $('#btnServisDevret').show();
        }
    }
    ...
    $('body').on('click', '#btnServisDevret', function() {
        ...
        prepareSelect2('#servisTeknisyeni1', '/summary/organizationalunititems', {
            publicId: 'E70081EB5F9E4970A9B556DB7467FC4F',
            name: 'User',
            filterType: 'User',
            groupIds: null,
            depth: 1,
        ...
        prepareSelect2('#servisTeknisyeni2', '/summary/organizationalunititems', {
            publicId: '510666169526497685FC978A5608C4B6',
            name: 'User',
            filterType: 'User',
            groupIds: null,
            depth: 1,
        ...
        prepareSelect2('#devredenKisi1', '/summary/organizationalunititems', {
            publicId: 'F8130232D8C54A0EB88D8356ADCC826D',
            name: 'User',
            filterType: 'User',
            groupIds: null,
            depth: 1,
        ...
        prepareSelect2('#devredenKisi2', '/summary/organizationalunititems', {
            publicId: '0AABBA74023E406D8FDF31A022746BA3',
            name: 'User',
            filterType: 'User',
            groupIds: null,
            depth: 1,
    ...
    $('body').on('click',
        ...
        function() {
            ...
            if ($('#servisTeknisyeni1').select2('data') != null) {
                teknisyen1Id = $('#servisTeknisyeni1').select2('data').id;
            } else {
                teknisyen1Id = '';
            }
            if ($('#servisTeknisyeni2').select2('data') != null) {
            ...
            if (!String.isNullOrWhiteSpace($('label[for=E70081EB5F9E4970A9B556DB7467FC4F]').parent().data('publicids'))) {
                if ($('label[for=E70081EB5F9E4970A9B556DB7467FC4F]').parent().data('publicids') !== teknisyen1Id) {
                    var teknisyen1data = {
                        customObjectId: "43170E7ED4E641C98B067B41AA42076D",
                        recordId: RecordId,
                        fieldId: 'E70081EB5F9E4970A9B556DB7467FC4F',
                        value: teknisyen1Id
                    };
                    var servisTeknisyeni1Id = $('label[for=E70081EB5F9E4970A9B556DB7467FC4F]').parent().data('publicids');
                    $.post('/Set/UpdateFieldValue', teknisyen1data, function(r) {
                        ...
                        var devredilen1data = {
                            customObjectId: "43170E7ED4E641C98B067B41AA42076D",
                            recordId: RecordId,
                            fieldId: 'F8130232D8C54A0EB88D8356ADCC826D',
                            value: servisTeknisyeni1Id
                        };
            ...
            if (!String.isNullOrWhiteSpace($('label[for=510666169526497685FC978A5608C4B6]').parent().data('publicids'))) {
                if ($('label[for=510666169526497685FC978A5608C4B6]').parent().data('publicids') !== teknisyen2Id) {
                    var teknisyen2data = {
                        customObjectId: "43170E7ED4E641C98B067B41AA42076D",
                        recordId: RecordId,
                        fieldId: '510666169526497685FC978A5608C4B6',
                        value: teknisyen2Id
                    };
                    var servisTeknisyeni2Id = $('label[for=510666169526497685FC978A5608C4B6]').parent().data('publicids');
                    $.post('/Set/UpdateFieldValue', teknisyen2data, function(r) {
                        ...
                        var devredilen2data = {
                            customObjectId: "43170E7ED4E641C98B067B41AA42076D",
                            recordId: RecordId,
                            fieldId: '0AABBA74023E406D8FDF31A022746BA3',
                            value: servisTeknisyeni2Id
                        };
            ...
            if ($('label[for=510666169526497685FC978A5608C4B6]').parent().data('publicids') == teknisyen2Id && $('label[for=E70081EB5F9E4970A9B556DB7467FC4F]').parent().data('publicids') == teknisyen1Id) {
                $('#msg').hide();
                setUtil.alert({
                    container: '#modelServisDevret .modal-body #txt',
                ...
                var checkboxData = {
                    customObjectId: "43170E7ED4E641C98B067B41AA42076D",
                    recordId: RecordId,
                    fieldId: 'BC9926716A98435792F37B92D11E13F5',
                    value: true
                };
